...
(function(factory) {
    ...
    var IconLayers = L.Control.extend({
        ...
        _onLayerClick: function(e) {
            ...
            console.log("PAULAAAAA"+layer.layerObj);
        ...
        _switchMapLayers: function() {
            ...
            clip();*/
            /* console.log("Capa activa "+Object.getOwnPropertyNames(activeLayer).forEach(function(val, idx, array) {
                console.log(val + " -> " + activeLayer[val]);
              }));
            console.log("Prueba "+activeLayer.title); */

            
            /* MODIFICADOOO ESPECIFICAMENTE PARA EL MAPA PUBLICO */
             var activeLayer = this._getActiveLayer();
            var previousLayer = this._getPreviousLayer();
            if (previousLayer) {
