L.Control.Info = L.Control.extend({
        ...
        options: {
          ...
          maxHeight: '50%',/*(window.innerHeight-82)+'px;',*/
          titleClass: '',
          contentClass: ''
        },
        ...
        onAdd: function(map) {
          ...
          var heightMapa = document.getElementById("map");
          infoBody.setAttribute('style', 'width:500px; max-width:'+ this.options.maxWidth + '; max-height: ' + (heightMapa.clientHeight-62) +'px;');
...
/*           var container = document.getElementsByClassName("leaflet-popup-content")[0];
          ...
          this._showTitle();
      		...
      		L.DomEvent
          .disableClickPropagation(infoContainer)
          .disableScrollPropagation(infoContainer);
