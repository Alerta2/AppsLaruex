...
Highcharts.getSVG = function (charts) {
    ...
    Highcharts.each(charts, function (chart) {
        ...
        //svg += '<p class="prueba-p">Hola</p>'//'<div class="highcharts-data-table" style="display: block; margin:auto;">'+chart.getTable()+'</div>';    
        //svg += chart.dataTableDiv;

        //var table = chart.dataTableDiv;
        var table = chart.getTable()
        if (table) {

            table = '<div class="highcharts-data-table" style="display: block;">'+table+'</div>';
            ...
            console.log("TABKE", table.innerHTML)
            console.log(table.all[0].innerHTML)
            svg += table.all[0].innerHTML;
        }

        svgArr.push(svg);
    });
    top += svgHeight;
    console.log(top, endWidth)
...
function LoadChart_ICA(info_estacion, contaminantes, FLAGS, ICA, elementChartICA) {
    ...
    Highcharts.chart(elementChartICA, {
        ...
        caption: {
            useHTML: true,
            text: `<p style="margin:0;"><img src="http://alerta2.es/static/img/spd/iconos/aviso.png" style="width:35px; height:30px"><b> Datos sujetos a validación </b><a class="infoICA" href="#">+ Informacion <i class="fas fa-mouse-pointer"></i></a></p>`
        },
        plotOptions: {
            spline: {
                lineWidth: 4,
        ...
        exporting: {
            ...
            chartOptions: {
                ...
                caption: {
                    useHTML: true,
                    text: `<p style="margin:0;"><img src="http://alerta2.es/static/img/spd/iconos/aviso.png" style="width:25px; height:20px"> Datos sujetos a validación</p>`
                },
            }
        }
    })
...
function LoadData_ActividadAnual(info_estacion, elementChartActividad) {
    ...
    $.ajax({
        ...
        dataType: "json",
        cache: false,
        url: "http://127.0.0.1:8000/media/veiex/2022_3053_global.json",
        success: function (data) {
            LoadChart_ActividadAnual(info_estacion, elementChartActividad, data);
        },
        error: function () {
            console.log("Error getJSON DATA Actividad industrial");
        },
        complete: function () {
...
function LoadChart_ActividadAnual(info_estacion, elementChartActividad, data) {
    ...
    Highcharts.ganttChart(elementChartActividad, {
        chart: {
            zoomType: 'x',
            panning: {
                enabled: true,
...
function LoadChart_Contaminante(info_estacion, info_data, info_ICA, FLAGS, ICA, elementSparkline, elementChartContaminante, elementChartICA, data) {
    ...
    Highcharts.chart(elementChartContaminante, {
        ...
        caption: {
            useHTML: true,
            text: '<p style="margin:0;"><img src="http://alerta2.es/static/img/spd/iconos/aviso.png" style="width:35px; height:30px"><b> Datos sujetos a validación </b><a class="infoFlags" href="#">+ Informacion <i class="fas fa-mouse-pointer"></i></a></p>'
        },
        tooltip: {
        ...
        exporting: {
            ...
            sourceHeight: 540,
            allowHTML: true,
            /*tableCaption: info_data.Parametro,
            showTable: false,*/
            menuItemDefinitions: {
                downloadPDF: {
                    onclick: function () {

                        Highcharts.exportCharts([this], {
                        ...
                        if (table) {
                            ...
                            /*this.renderer.text('This text is <span style="color: red">styled</span> and <a href="http://example.com">linked</a>', 150, 80)
                                .css({
                                    color: '#4572A7',
                                    fontSize: '16px'
                                })
            ...
            chartOptions: {
                ...
                chart: {
                    events: {
                        load: function () {
                            console.log("PRUEBA", this, this.exportChart);
                            console.log(this.options.exporting.type)
                ...
                caption: {
                    useHTML: true,
                    text: `<p style="margin:0;"><img src="http://alerta2.es/static/img/spd/iconos/aviso.png" style="width:25px; height:20px"> Datos sujetos a validación<br>
...
function LoadGauge_Promedios(info_estacion, info_data, elementChartGauge, data) {
    ...
    Highcharts.chart(elementChartGauge, {
        ...
        title: {
            text: "Promedios semihorarios validados",
            style: {
                color: '#fff'
            }
        },
        ...
        yAxis: {
            ...
            stops: [
                [0.95, '#CB4335'], // red - No cumple el 94%
                [0.95, '#55BF3B'] // green - Si cumple el 94%
