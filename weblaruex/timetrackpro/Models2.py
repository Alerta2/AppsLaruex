...
class RelacinDeEmpleados(models.Model):
    ...
    l�mite_empleados_0_admin_1_field = models.CharField(db_column='L�mite(Empleados 0/Admin 1)', max_length=255, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
    ...
    n�mero_de_m�quina = models.CharField(db_column='N�mero de m�quina', max_length=255, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
    f16 = models.CharField(max_length=255, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'relaci�n de empleados'
