...
urlpatterns = [
    ...
    path('private/timetrackpro/eliminar-registro/<slug:id>/', eliminarArchivoRegistro , name='eliminar-registro'),
    ...
    path('private/timetrackpro/datos-festivos/', datosFestivos , name='datos-festivos'),
    path('private/timetrackpro/datos-festivos/<slug:year>/', datosFestivos , name='datos-festivos'),
    ...
    path('private/timetrackpro/editar-festivo/<slug:id>/', editarFestivo , name='editar-festivo'),
    path('private/timetrackpro/eliminar-festivo/<slug:id>/', eliminarFestivo , name='eliminar-festivo'),
    ...
    path('private/timetrackpro/modificar-vacaciones/<slug:id>/', modificarVacaciones , name='modificar-vacaciones'),
