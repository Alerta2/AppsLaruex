...
var layer_zonas_met_aemet = L.geoJson(aemet, {
    ...
    onEachFeature: function (feature, layer) {
        ...
        layer.bindPopup(
            ...
            //+'<div id="'+feature.properties.COD_Z+'" class="ZMA"></div>'
...
function IconoEstadoEstacion(estado) {
    switch (estado) {
        ...
        default: /* Error */
            return '<i class="fas fa-times" style="color:#455A64;stroke: #1B1C1C;stroke-width: 20;"></i>';
    }
};

/* Color de la carta que representa el nivel de rio de una estacion y su estado*/
function ColorCardEstadoEstacion(estado){
    switch (estado) {
        case -1: /* Sin datos */
            return 'card-purple';
        case 0: /* Verde */
