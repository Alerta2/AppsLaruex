...
class AvisosMeteorologicosAemet(models.Model):
    ...
    nombre_zona_meteo_aemet = models.CharField(db_column='NOMBRE_ZONA_METEO_AEMET', max_length=200)  # Field name made lowercase.
    fecha_emision = models.DateTimeField(db_column='FECHA_EMISION')  # Field name made lowercase.
    ...
    estado_aviso = models.IntegerField(db_column='ESTADO_AVISO', blank=True, null=True)  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'avisos_meteorologicos_aemet'
        unique_together = (('nivel', 'id_zona_meteo_aemet', 'fecha_comienzo', 'fecha_fin', 'nombre_zona_meteo_aemet'),)
...
class CamarasSaih(models.Model):
    id_estacion = models.OneToOneField('Estaciones', models.DO_NOTHING, db_column='ID_ESTACION', primary_key=True, related_name='estaciones_camaras')  # Field name made lowercase.
    data = models.CharField(db_column='DATA', max_length=200)  # Field name made lowercase.
    url = models.CharField(db_column='URL', max_length=200)  # Field name made lowercase.
    streaming = models.CharField(db_column='STREAMING', max_length=500, blank=True, null=True)  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'camaras_saih'
        unique_together = (('id_estacion', 'data', 'url'),)
...
class UltimasImagenes(models.Model):
    id_estacion = models.OneToOneField(Estaciones, models.DO_NOTHING, db_column='ID_ESTACION', primary_key=True, related_name='estaciones_ultimas_imagenes')  # Field name made lowercase.
...
class UltimosValores(models.Model):
    id_estacion = models.OneToOneField(Estaciones, models.DO_NOTHING, db_column='ID_ESTACION', primary_key=True, related_name='estaciones_ultimos_valores')  # Field name made lowercase.
    id_canal = models.ForeignKey(Canales, models.DO_NOTHING, db_column='ID_CANAL')  # Field name made lowercase.
    fecha_hora_utc = models.DateTimeField(db_column='FECHA_HORA_UTC')  # Field name made lowercase.
    fecha_hora_local = models.DateTimeField(db_column='FECHA_HORA_LOCAL')  # Field name made lowercase.
    valor = models.FloatField(db_column='VALOR')  # Field name made lowercase.
...
class UmbralesRios(models.Model):
    id_estacion = models.OneToOneField(Estaciones, models.DO_NOTHING, db_column='ID_ESTACION', primary_key=True, related_name="estaciones_umbrales")  # Field name made lowercase.
